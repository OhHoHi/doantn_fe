...
class OrderMonth extends StatelessWidget {
  OrderMonth({Key? key})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: BodyOrderMonth(),
    );
  }
}

class BodyOrderMonth extends StatefulWidget {
  BodyOrderMonth({Key? key }) : super(key: key);
  @override
  State<BodyOrderMonth> createState() => _OrderMonthState();
}

class _OrderMonthState extends State<BodyOrderMonth> {
late ThongKeProvider thongKeProvider;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      thongKeProvider.getListOrderWithMonth();
    });
  }
    ...
    return
      Selector<ThongKeProvider, Status>(builder: (context, value, child) {
        ...
        return Padding(
          ...
          child: _buildChart(thongKeProvider.listMonthOrder),
        );
      }, selector: (context, pro) {
        return pro.statusMonthOrder;
      });
  }
Widget _buildChart(List<MonthlyResponse> data) {
  return Container(
        ...
        titlesData: FlTitlesData(
          ...
          bottomTitles: SideTitles(
            ...
            getTitles: (double value) {
              return '${data[value.toInt()].month}/${data[value.toInt()].year}';
            },
          ),
...
double _calculateMaxValue(List<MonthlyResponse> data) {
  double max = 0;
