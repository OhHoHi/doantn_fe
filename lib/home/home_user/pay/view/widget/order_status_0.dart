...
class OrderStatus0 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: BodyOrderStatus0(isAdmin: isAdmin, initialTabIndex: initialTabIndex),
    );
  }
}

class BodyOrderStatus0 extends StatefulWidget {
  BodyOrderStatus0({Key? key , required this.isAdmin , required this.initialTabIndex}) : super(key: key);
  bool isAdmin ;
  final int initialTabIndex;
  @override
